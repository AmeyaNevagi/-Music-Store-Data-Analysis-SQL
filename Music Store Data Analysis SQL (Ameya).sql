...
/* (3)Return all the track names that have a song length longer than the average song length.
      Return the name and milliseons for each track,order the songs length with the longest songs listed first.                      */
...
/* (2)We want to find out the most popular music genre for each country. 
      We determine the most popular genre as the the genre with the hightest number of purchases                                    */

WITHpopular_genre AS (
...
/* (3)Write a query that determines the customr that has spent the most on music for each country.
